...
*Give your AI agent a brain that actually remembers — across sessions, across agents, across time. This standalone enhanced edition also adds Dreaming-compatible outputs.*
...
| **Dreaming Compatibility** | Emits `DREAMS.md` and `.dreams/*` so Dreaming UI can work without giving up `memory-lancedb-pro` |
...
- `dreaming.enabled + frequency` → generates `DREAMS.md` and Dreaming-compatible short-term artifacts
...
If you are using this enhanced standalone edition, these are the most important project docs:

- [Standalone Project Guide](docs/standalone-project.md)
- [Dreaming Compatibility Design](docs/dreaming-compatibility.md)
...
1. Start with the standalone project guide for project scope and setup shape
2. Read the Dreaming design note for the compatibility layer and file contracts
3. Read the architecture analysis for the main write/retrieve/lifecycle paths
4. Use the integration playbook for real deployment and regression work
